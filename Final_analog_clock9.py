...
class make_clock:
	...
	def create1(self):
		...
		for i in range(12):
			...
			self.canvas.create_text(self.convert.change(x_coord-0.4,y_coord-0.4),fill='blue',text=str(i+1),font='calibri 9')
		#self.create_needles()
		#self.create_circle(-1,0)
	...
	def create2(self):
		...
		for i in range(31):
			...
			self.canvas.create_text(self.convert.change(x_coord+0.35,y_coord-0.35),fill='blue',text=str(i+1),font='calibri 7 bold')
		#self.create_needles()
		#self.create_circle(-1,0)
