...
class make_clock:
	...
	def create(self):
		self.canvas.delete(ALL)
#		self.canvas.create_oval(self.convert.coords(-1.2,-1.2,1.2,1.2),fill='black')
...
#		self.canvas.create_oval(self.convert.coords(-1.2,-1.2,1.2,1.2),fill=self.color_inner_circles)
